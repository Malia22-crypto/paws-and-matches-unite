...
@InputType()
class AdoptionRequestUpdateInput {
  @ApiProperty({
    required: false,
    type: () => UserUpdateManyWithoutAdoptionRequestsInput,
  })
  @ValidateNested()
  @Type(() => UserUpdateManyWithoutAdoptionRequestsInput)
  @IsOptional()
  @Field(() => UserUpdateManyWithoutAdoptionRequestsInput, {
    nullable: true,
  })
...
export { AdoptionRequestUpdateInput as AdoptionRequestUpdateInput };
