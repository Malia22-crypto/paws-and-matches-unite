...
@InputType()
class AdoptionRequestCreateNestedManyWithoutPetsInput {
...
export { AdoptionRequestCreateNestedManyWithoutPetsInput as AdoptionRequestCreateNestedManyWithoutPetsInput };
